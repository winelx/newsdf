...
public class PhotoPreview {
    ...
    public final static String EXTRA_TITLE = "show_delete";
    ...
    public static class PhotoPreviewBuilder {
        ...
        public PhotoPreviewBuilder setTitle(ArrayList<String> photoTitle) {
            mPreviewOptionsBundle.putStringArrayList(EXTRA_TITLE, photoTitle);
            return this;
        }
